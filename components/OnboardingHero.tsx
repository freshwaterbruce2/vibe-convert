    ...
    <div className="w-full max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
        ...
        <div className="relative group">
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 hover:border-cyan-500/30 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-900 h-full">
          ...
          <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 text-slate-700 z-10">
        ...
        {/* Step 2 */}
        <div className="relative group">
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 hover:border-purple-500/30 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-900 h-full">
        ...
        {/* Step 3 */}
        <div className="relative group">
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 hover:border-green-500/30 transition-all duration-300 hover:-translate-y-1 hover:bg-slate-900 h-full">
